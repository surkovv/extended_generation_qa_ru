...
add_test('case8', 'Как расценивал Мендрелеев капитал?', 'временную форму ', 'Мендрелеев расценивал капитал как временную форму.')
add_test('case8', 'Как можно охарактеризовать мелодии соул-джаза? ', 'Стремительно закрученные ', 'Мелодии соул-джаза можно охарактеризовать как стремительно закрученные.')
...
add_test('case8', 'Как еще называют термин эйсид-джаз ?', 'Кислотный джаз', 'Еще называют термин эйсид-джаз кислотный джаз')
add_test('case8', 'Как дословно переводится слово фьюжн? ', 'сплав', 'Слово фьюжн дословно переводится  как сплав.')
add_test('case8', 'Как называются признаки по которым противопоставляются фоны разных фонем в языке?', 'Называются различительными, или дифференциальными ', 'признаки по которым противопоставляются фоны разных фонем в языке называются различительными, или дифференциальными.')
...
add_test('case8', 'Как описывался троллейбус в ранних публикациях на русском языке? ', 'как безрельсовый трамвай', 'Троллейбус описывался в ранних публикациях на русском языке как безрельсовый трамвай.')
