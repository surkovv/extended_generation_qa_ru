...
add_test('case9', 'Сколько раз Реджинальд Дохерти стал чемпионом с 1897 по 1900 год?', 'четыре раза подряд', 'Реджинальд Дохерти стал чемпионом четыре раза подряд с 1897 по 1900 год.')
...
add_test('case9', 'Сколько взрывчатки было поставлено в СССР по ленд-лизу?', '345 735 тонн', '345 735 тонн взрывчатки было поставлено в СССР по ленд-лизу.')
...
add_test('case9', 'Сколько видов полухордовых известно в мире?', 'Около 100 видов.', 'Около 100 видов сколько видов полухордовых известно в мире.')
add_test('case9', 'Сколько в плазме органических веществ?', 'около 9 %', 'В плазме около 9 % органических веществ.')
...
add_test('case9', 'Сколько произведений, по исчислению Кёхеля, написал Моцарт?', 'В общей сложности 626 произведений.', 'Моцарт написал в общей сложности 626 произведений, по исчислению Кёхеля.')
add_test('case9', 'Сколько Хаббл работает на орбите?', '15 лет', 'Хаббл работает 15 лет на орбите.')
add_test('case9', 'из скольки классов состоят гимназии?', 'из 7', 'Из 7 классов состоят гимназии.')
add_test('case9', 'На сколько процентов, по сравнению с аналогичным периодом прошлого года, сократился транзит в порты Эстонии?', 'на 14,5 %', 'Транзит в порты Эстонии сократился на 14,5 % по сравнению с аналогичным периодом прошлого года.')
...
add_test('case9', 'Сколько в процентах достигает подземный сток к речному на силурийском и ордовикском плато в бассейне реки Мяркис?', '70 %', 'Подземный сток к речному на силурийском и ордовикском плато в бассейне реки Мяркис достигает 70%.')
add_test('case9', 'При скольки градусах плавится α-цирконий?', '1855 °C', 'α-цирконий плавится при 1855 °C.')
